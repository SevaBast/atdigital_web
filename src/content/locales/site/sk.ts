...
export const sk: SiteContent = {
  ...
  partners: {
    ...
    logos: [
      ...
      { name: "EdgeCom", image: "/partners/edgecom.webp" },
      { name: "University of Žilina", image: "/partners/uniza.webp" },
      ...
      { name: "Schafer", image: "/partners/schafer.webp" },
      { name: "SM", image: "/partners/sm.webp" },
      { name: "Tatravakonka", image: "/partners/tatravagonka.webp" },
      { name: "Tuke", image: "/partners/tuke.webp" },
      { name: "Bata", image: "/partners/bata.webp" },
  ...
  products: {
    ...
    categories: [
      ...
      },
      {
        ...
        icon: "CalendarClock",
        media: { type: "video", src: "/atdigital_web/reference/pridat.mp4" },
      ...
      },
      {
        ...
        icon: "Radio",
        media: { type: "image", src: "/atdigital_web/picture/products/example.webp" },
